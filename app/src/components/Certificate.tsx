...
export function Certificate({ businessName, variant, dateJoined }: CertificateProps) {
    ...
    >
      ...
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ fontSize: 12.5, color: 'var(--ink2)', marginTop: isFull ? 8 : 6, lineHeight: 1.5, maxWidth: '32ch', marginLeft: 'auto', marginRight: 'auto' }}>
          is officially one of the Founding Businesses of Locals for Locals Davao.
        </div>
        <div
          style={{
            display: 'inline-flex',
        ...
        >
          ...
          <span style={{ fontFamily: 'var(--font-display)', fontSize: isFull ? 30 : 26, fontWeight: 800, lineHeight: 1 }}>
            {String(FOUNDING_PARTNER_NUMBER).padStart(2, '0')}
          </span>
          <span style={{ fontSize: 9, color: 'rgba(247,244,238,.7)' }}>of {FOUNDING_PARTNER_CAP}</span>
        </div>
        {isFull ? (
          <>
